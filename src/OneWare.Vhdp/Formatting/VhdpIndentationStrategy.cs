...
public class VhdpIndentationStrategy : DefaultIndentationStrategy
{
    ...
    /// </summary>
    public VhdpIndentationStrategy()
    {
    }
    ...
    /// </summary>
    public VhdpIndentationStrategy(TextEditorOptions options)
    {
    ...
    public void Indent(IDocumentAccessor document, bool keepEmptyLines)
    {
        ...
        var r = new IndentationReformatterVhdp();
